...
//     /// 첫 빌드시, 권한 확인하기
//     /// 아이폰은 무조건 받아야 하고, 안드로이드는 상관 없음. 따로 유저가 설정하지 않는 한, 자동 권한 확보 상태
...
//
//
//   /// * foreground 알림 위한 flutter_local_notification 라이브러리 *
//   ///
...
//
//
//     // 콘솔에서 발송하는 메시지를 message 파라미터로 받아온다.
//     /// 포그라운드 상황에서 메시지가 올 때마다 listen 내부 콜백이 실행된다.
